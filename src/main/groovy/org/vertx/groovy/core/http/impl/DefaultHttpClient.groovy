...
class DefaultHttpClient implements HttpClient {
  ...
  HttpClientRequest options(String uri, Closure responseHandler) {
    return new DefaultHttpClientRequest(jClient.options(uri, {responseHandler(new DefaultHttpClientResponse(it))} as Handler))
  }

  @Override
  HttpClientRequest get(String uri, Closure responseHandler) {
    return new DefaultHttpClientRequest(jClient.get(uri, {responseHandler(new DefaultHttpClientResponse(it))} as Handler))
  }

  @Override
  HttpClientRequest head(String uri, Closure responseHandler) {
    return new DefaultHttpClientRequest(jClient.head(uri, {responseHandler(new DefaultHttpClientResponse(it))} as Handler))
  }

  @Override
  HttpClientRequest post(String uri, Closure responseHandler) {
    return new DefaultHttpClientRequest(jClient.post(uri, {responseHandler(new DefaultHttpClientResponse(it))} as Handler))
  }

  @Override
  HttpClientRequest put(String uri, Closure responseHandler) {
    return new DefaultHttpClientRequest(jClient.put(uri, {responseHandler(new DefaultHttpClientResponse(it))} as Handler))
  }

  @Override
  HttpClientRequest delete(String uri, Closure responseHandler) {
    return new DefaultHttpClientRequest(jClient.delete(uri, {responseHandler(new DefaultHttpClientResponse(it))} as Handler))
  }

  @Override
  HttpClientRequest trace(String uri, Closure responseHandler) {
    return new DefaultHttpClientRequest(jClient.trace(uri, {responseHandler(new DefaultHttpClientResponse(it))} as Handler))
  }

  @Override
  HttpClientRequest connect(String uri, Closure responseHandler) {
    return new DefaultHttpClientRequest(jClient.connect(uri, {responseHandler(new DefaultHttpClientResponse(it))} as Handler))
  }

  @Override
  HttpClientRequest patch(String uri, Closure responseHandler) {
    return new DefaultHttpClientRequest(jClient.patch(uri, {responseHandler(new DefaultHttpClientResponse(it))} as Handler))
  }

  @Override
  HttpClientRequest request(String method, String uri, Closure responseHandler) {
    return new DefaultHttpClientRequest(jClient.request(method, uri, {responseHandler(new DefaultHttpClientResponse(it))} as Handler))
  }
